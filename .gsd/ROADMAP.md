...
- [x] Real-time Group Chat & DMs (REQ-11, REQ-12)
...
- [x] Implement Swipe Deck UI (react-spring + @use-gesture/react).
- [x] Logic for 7-day activity filtering & eligibility checks.
- [x] Atomic match transaction (Create Team + Chat + Match record).
- [x] Team Naming gate for leaders.
...
- [x] Real-time text-only group chat implementation.
- [x] Real-time DMs for Explore matches.
- [x] Notification system for matches and messages.
